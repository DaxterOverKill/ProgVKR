...
.method constructor <init>(Landroidx/vectordrawable/graphics/drawable/h$c;)V
    ...
    iget-object v0, p1, Landroidx/vectordrawable/graphics/drawable/h$c;->f:Lw/b;

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h$c;->f:Lw/b;
    ...
    iget-object v0, p1, Landroidx/vectordrawable/graphics/drawable/h$c;->h:Lw/b;

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h$c;->h:Lw/b;
...
.method private h(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-static {p2, v0}, Lw/g;->r(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    invoke-static {v0}, Lx/c;->d(Ljava/lang/String;)[Lx/c$b;
    ...
    invoke-static/range {v1 .. v6}, Lw/g;->i(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources$Theme;Ljava/lang/String;II)Lw/b;
    ...
    invoke-static {p1, p2, v2, v0, v1}, Lw/g;->j(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F
    ...
    invoke-static {p1, p2, v1, v0, v2}, Lw/g;->k(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I
    ...
    iput-object p3, p0, Landroidx/vectordrawable/graphics/drawable/h$c;->f:Lw/b;
    ...
    invoke-static {p1, p2, v1, p3, v0}, Lw/g;->j(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F
    ...
    invoke-static {p1, p2, v1, p3, v0}, Lw/g;->k(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I
...
.method public a()Z
    ...
    iget-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h$c;->h:Lw/b;

    invoke-virtual {v0}, Lw/b;->i()Z

    move-result v0

    if-nez v0, :cond_1

    iget-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h$c;->f:Lw/b;
...
.method public b([I)Z
    ...
    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/h$c;->f:Lw/b;

    invoke-virtual {v1, p1}, Lw/b;->j([I)Z
...
.method public g(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-static {p1, p3, p2, v0}, Lw/g;->s(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
...
.method setFillColor(I)V
    ...
    invoke-virtual {v0, p1}, Lw/b;->k(I)V
