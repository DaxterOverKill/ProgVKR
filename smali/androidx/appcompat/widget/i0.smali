...
# instance fields
.field private final A:Landroidx/appcompat/widget/i0$c;
...
.field final x:Landroidx/appcompat/widget/i0$g;

.field private final y:Landroidx/appcompat/widget/i0$f;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/i0;->x:Landroidx/appcompat/widget/i0$g;
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/i0;->A:Landroidx/appcompat/widget/i0$c;

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, p0, Landroidx/appcompat/widget/i0;->C:Landroid/graphics/Rect;

    iput-object p1, p0, Landroidx/appcompat/widget/i0;->b:Landroid/content/Context;
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/i0;->B:Landroid/os/Handler;

    sget-object v1, Lb/j;->d1:[I
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/i0;->F:Landroid/widget/PopupWindow;
...
.method private N(Z)V
    ...
    :try_start_0
    iget-object v1, p0, Landroidx/appcompat/widget/i0;->F:Landroid/widget/PopupWindow;
    ...
    :cond_0
    iget-object v0, p0, Landroidx/appcompat/widget/i0;->F:Landroid/widget/PopupWindow;
...
.method private q()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/i0;->d:Landroidx/appcompat/widget/e0;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/i0;->b:Landroid/content/Context;
    ...
    iget-boolean v5, p0, Landroidx/appcompat/widget/i0;->E:Z
    ...
    iput-object v5, p0, Landroidx/appcompat/widget/i0;->d:Landroidx/appcompat/widget/e0;
    ...
    :cond_0
    iget-object v5, p0, Landroidx/appcompat/widget/i0;->d:Landroidx/appcompat/widget/e0;

    iget-object v6, p0, Landroidx/appcompat/widget/i0;->c:Landroid/widget/ListAdapter;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/i0;->z:Landroidx/appcompat/widget/i0$e;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/i0;->d:Landroidx/appcompat/widget/e0;
    ...
    :goto_2
    iget-object v6, p0, Landroidx/appcompat/widget/i0;->F:Landroid/widget/PopupWindow;
    ...
    :goto_3
    iget-object v5, p0, Landroidx/appcompat/widget/i0;->F:Landroid/widget/PopupWindow;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/i0;->C:Landroid/graphics/Rect;

    invoke-virtual {v5, v6}, Landroid/graphics/drawable/Drawable;->getPadding(Landroid/graphics/Rect;)Z

    iget-object v5, p0, Landroidx/appcompat/widget/i0;->C:Landroid/graphics/Rect;
    ...
    iget-boolean v7, p0, Landroidx/appcompat/widget/i0;->j:Z

    if-nez v7, :cond_9

    neg-int v6, v6

    iput v6, p0, Landroidx/appcompat/widget/i0;->h:I
    ...
    iget v6, p0, Landroidx/appcompat/widget/i0;->h:I
    ...
    :cond_c
    iget-object v2, p0, Landroidx/appcompat/widget/i0;->b:Landroid/content/Context;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/i0;->C:Landroid/graphics/Rect;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/i0;->d:Landroidx/appcompat/widget/e0;

    invoke-virtual {v2}, Landroid/widget/ListView;->getPaddingTop()I

    move-result v2

    iget-object v3, p0, Landroidx/appcompat/widget/i0;->d:Landroidx/appcompat/widget/e0;
...
.method private u(Landroid/view/View;IZ)I
    ...
    :cond_0
    iget-object p3, p0, Landroidx/appcompat/widget/i0;->F:Landroid/widget/PopupWindow;
...
.method public F(I)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/i0;->C:Landroid/graphics/Rect;
...
.method public H(Landroid/graphics/Rect;)V
    ...
    :goto_0
    iput-object v0, p0, Landroidx/appcompat/widget/i0;->D:Landroid/graphics/Rect;
...
.method public dismiss()V
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/i0;->d:Landroidx/appcompat/widget/e0;

    iget-object v0, p0, Landroidx/appcompat/widget/i0;->B:Landroid/os/Handler;

    iget-object v1, p0, Landroidx/appcompat/widget/i0;->x:Landroidx/appcompat/widget/i0$g;
...
.method public g()V
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/i0;->F:Landroid/widget/PopupWindow;
    ...
    :cond_2
    :goto_0
    iget v7, p0, Landroidx/appcompat/widget/i0;->e:I
    ...
    iget-object v7, p0, Landroidx/appcompat/widget/i0;->F:Landroid/widget/PopupWindow;
    ...
    iget v10, p0, Landroidx/appcompat/widget/i0;->h:I
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/i0;->D:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/i0;->A:Landroidx/appcompat/widget/i0$c;
...
.method public o(Landroid/widget/ListAdapter;)V
    ...
    :cond_0
    iget-object v1, p0, Landroidx/appcompat/widget/i0;->c:Landroid/widget/ListAdapter;
    ...
    :cond_1
    :goto_0
    iput-object p1, p0, Landroidx/appcompat/widget/i0;->c:Landroid/widget/ListAdapter;
    ...
    :cond_2
    iget-object p1, p0, Landroidx/appcompat/widget/i0;->d:Landroidx/appcompat/widget/e0;

    if-eqz p1, :cond_3

    iget-object v0, p0, Landroidx/appcompat/widget/i0;->c:Landroid/widget/ListAdapter;
