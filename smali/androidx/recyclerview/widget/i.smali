...
.method private I()V
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/i;->z:Landroidx/core/view/d;
...
.method private J()V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/recyclerview/widget/i;->z:Landroidx/core/view/d;

    if-eqz v0, :cond_1

    iput-object v1, p0, Landroidx/recyclerview/widget/i;->z:Landroidx/core/view/d;

    :cond_1
    return-void
.end method

.method private K(Landroidx/recyclerview/widget/RecyclerView$d0;)I
    .locals 5
    ...
    invoke-virtual {v0, v2, p1}, Landroidx/recyclerview/widget/i$f;->k(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;)I
    ...
    invoke-static {v3}, Landroidx/core/view/u;->B(Landroid/view/View;)I

    move-result v3

    invoke-virtual {v2, v0, v3}, Landroidx/recyclerview/widget/i$f;->d(II)I
    ...
    invoke-direct {p0, p1, v2}, Landroidx/recyclerview/widget/i;->n(Landroidx/recyclerview/widget/RecyclerView$d0;I)I
    ...
    invoke-static {p1}, Landroidx/core/view/u;->B(Landroid/view/View;)I

    move-result p1

    invoke-static {v3, p1}, Landroidx/recyclerview/widget/i$f;->e(II)I
    ...
    :cond_3
    invoke-direct {p0, p1, v2}, Landroidx/recyclerview/widget/i;->p(Landroidx/recyclerview/widget/RecyclerView$d0;I)I
    ...
    invoke-static {v0}, Landroidx/core/view/u;->B(Landroid/view/View;)I

    move-result v0

    invoke-static {p1, v0}, Landroidx/recyclerview/widget/i$f;->e(II)I
...
.method private n(Landroidx/recyclerview/widget/RecyclerView$d0;I)I
    .locals 8
    ...
    invoke-virtual {v6, v7}, Landroidx/recyclerview/widget/i$f;->n(F)F
    ...
    invoke-virtual {v3, v4}, Landroidx/recyclerview/widget/i$f;->l(F)F
    ...
    invoke-virtual {v2, p1}, Landroidx/recyclerview/widget/i$f;->m(Landroidx/recyclerview/widget/RecyclerView$d0;)F
...
.method private p(Landroidx/recyclerview/widget/RecyclerView$d0;I)I
    .locals 8
    ...
    invoke-virtual {v3, v5}, Landroidx/recyclerview/widget/i$f;->l(F)F
...
.method private q()V
    ...
    invoke-virtual {v2, v3, v1}, Landroidx/recyclerview/widget/i$f;->c(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;)V
...
.method private u(Landroidx/recyclerview/widget/RecyclerView$d0;)Ljava/util/List;
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v2}, Landroidx/recyclerview/widget/i$f;->h()I
    ...
    invoke-virtual {v8}, Landroidx/recyclerview/widget/RecyclerView$o;->O()I
    ...
    invoke-virtual {v8, v11}, Landroidx/recyclerview/widget/RecyclerView$o;->N(I)Landroid/view/View;
...
.method private v(Landroid/view/MotionEvent;)Landroidx/recyclerview/widget/RecyclerView$d0;
    .locals 6
...
.method B(Landroidx/recyclerview/widget/i$h;I)V
    .locals 2
...
.method E()Z
    ...
    invoke-virtual {v1, v9, v10}, Landroidx/recyclerview/widget/RecyclerView$o;->o(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-virtual/range {v9 .. v15}, Landroidx/recyclerview/widget/i$f;->p(Landroidx/recyclerview/widget/RecyclerView;IIIJ)I
...
.method F(Landroidx/recyclerview/widget/RecyclerView$d0;I)V
    .locals 23
    ...
    invoke-virtual {v11, v12, v14}, Landroidx/recyclerview/widget/i;->r(Landroidx/recyclerview/widget/RecyclerView$d0;Z)V
    ...
    invoke-direct/range {p0 .. p0}, Landroidx/recyclerview/widget/i;->l()V
    ...
    :cond_3
    invoke-direct {v11, v9}, Landroidx/recyclerview/widget/i;->K(Landroidx/recyclerview/widget/RecyclerView$d0;)I
    ...
    invoke-direct {v11, v0}, Landroidx/recyclerview/widget/i;->w([F)V
    ...
    invoke-virtual {v0, v1, v15, v2, v3}, Landroidx/recyclerview/widget/i$f;->g(Landroidx/recyclerview/widget/RecyclerView;IFF)J

    move-result-wide v0

    invoke-virtual {v14, v0, v1}, Landroidx/recyclerview/widget/i$h;->b(J)V

    iget-object v0, v11, Landroidx/recyclerview/widget/i;->p:Ljava/util/List;

    invoke-interface {v0, v14}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {v14}, Landroidx/recyclerview/widget/i$h;->d()V
    ...
    invoke-virtual {v11, v1}, Landroidx/recyclerview/widget/i;->D(Landroid/view/View;)V
    ...
    invoke-virtual {v1, v2, v0}, Landroidx/recyclerview/widget/i$f;->c(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;)V
    ...
    invoke-virtual {v0, v1, v12}, Landroidx/recyclerview/widget/i$f;->f(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;)I
...
.method public H(Landroidx/recyclerview/widget/RecyclerView$d0;)V
    ...
    invoke-virtual {v0, v1, p1}, Landroidx/recyclerview/widget/i$f;->o(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;)Z
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/recyclerview/widget/i;->F(Landroidx/recyclerview/widget/RecyclerView$d0;I)V
...
.method public d(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1, v1}, Landroidx/recyclerview/widget/i;->F(Landroidx/recyclerview/widget/RecyclerView$d0;I)V

    goto :goto_0

    :cond_1
    invoke-virtual {p0, p1, v1}, Landroidx/recyclerview/widget/i;->r(Landroidx/recyclerview/widget/RecyclerView$d0;Z)V
    ...
    invoke-virtual {v0, v1, p1}, Landroidx/recyclerview/widget/i$f;->c(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;)V
...
.method public i(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$a0;)V
    ...
    invoke-virtual/range {v1 .. v8}, Landroidx/recyclerview/widget/i$f;->w(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;Ljava/util/List;IFF)V
...
.method public k(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$a0;)V
    ...
    invoke-virtual/range {v1 .. v8}, Landroidx/recyclerview/widget/i$f;->x(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;Ljava/util/List;IFF)V
...
.method o(ILandroid/view/MotionEvent;I)V
    ...
    invoke-virtual {p1}, Landroidx/recyclerview/widget/i$f;->q()Z
    ...
    :cond_1
    invoke-direct {p0, p2}, Landroidx/recyclerview/widget/i;->v(Landroid/view/MotionEvent;)Landroidx/recyclerview/widget/RecyclerView$d0;
    ...
    invoke-virtual {v2, v3, p1}, Landroidx/recyclerview/widget/i$f;->f(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;)I
...
.method r(Landroidx/recyclerview/widget/RecyclerView$d0;Z)V
    .locals 3
    ...
    iget-object v2, v1, Landroidx/recyclerview/widget/i$h;->e:Landroidx/recyclerview/widget/RecyclerView$d0;

    if-ne v2, p1, :cond_1

    iget-boolean p1, v1, Landroidx/recyclerview/widget/i$h;->k:Z

    or-int/2addr p1, p2

    iput-boolean p1, v1, Landroidx/recyclerview/widget/i$h;->k:Z

    iget-boolean p1, v1, Landroidx/recyclerview/widget/i$h;->l:Z
...
.method s(Landroid/view/MotionEvent;)Landroidx/recyclerview/widget/i$h;
    .locals 4
    ...
    iget-object v3, v2, Landroidx/recyclerview/widget/i$h;->e:Landroidx/recyclerview/widget/RecyclerView$d0;
...
.method t(Landroid/view/MotionEvent;)Landroid/view/View;
    ...
    iget v4, v2, Landroidx/recyclerview/widget/i$h;->i:F

    iget v2, v2, Landroidx/recyclerview/widget/i$h;->j:F
...
.method x()Z
    ...
    iget-boolean v3, v3, Landroidx/recyclerview/widget/i$h;->l:Z
...
.method z(Landroidx/recyclerview/widget/RecyclerView$d0;)V
    .locals 10
    ...
    invoke-virtual {v0, p1}, Landroidx/recyclerview/widget/i$f;->j(Landroidx/recyclerview/widget/RecyclerView$d0;)F
    ...
    :cond_2
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/i;->u(Landroidx/recyclerview/widget/RecyclerView$d0;)Ljava/util/List;
    ...
    invoke-virtual {v1, p1, v0, v8, v9}, Landroidx/recyclerview/widget/i$f;->b(Landroidx/recyclerview/widget/RecyclerView$d0;Ljava/util/List;II)Landroidx/recyclerview/widget/RecyclerView$d0;
    ...
    :cond_4
    invoke-virtual {v6}, Landroidx/recyclerview/widget/RecyclerView$d0;->j()I
    ...
    invoke-virtual {v0, v1, p1, v6}, Landroidx/recyclerview/widget/i$f;->y(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;Landroidx/recyclerview/widget/RecyclerView$d0;)Z
    ...
    invoke-virtual/range {v2 .. v9}, Landroidx/recyclerview/widget/i$f;->z(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;ILandroidx/recyclerview/widget/RecyclerView$d0;III)V
