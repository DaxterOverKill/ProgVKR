...
.method public static t(II)I
    ...
    invoke-static {v1, v0}, Landroidx/recyclerview/widget/i$f;->s(II)I

    move-result v0

    const/4 v1, 0x1

    invoke-static {v1, p1}, Landroidx/recyclerview/widget/i$f;->s(II)I
    ...
    invoke-static {v0, p0}, Landroidx/recyclerview/widget/i$f;->s(II)I
...
.method public A(Landroidx/recyclerview/widget/RecyclerView$d0;I)V
    ...
    invoke-interface {p2, p1}, Landroidx/recyclerview/widget/j;->d(Landroid/view/View;)V
...
.method final f(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;)I
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/recyclerview/widget/i$f;->k(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;)I
    ...
    invoke-virtual {p0, p2, p1}, Landroidx/recyclerview/widget/i$f;->d(II)I
...
.method o(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;)Z
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/recyclerview/widget/i$f;->f(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;)I
...
.method public p(Landroidx/recyclerview/widget/RecyclerView;IIIJ)I
    ...
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/i$f;->i(Landroidx/recyclerview/widget/RecyclerView;)I
...
.method public u(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;FFIZ)V
    ...
    invoke-interface/range {v0 .. v7}, Landroidx/recyclerview/widget/j;->c(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroid/view/View;FFIZ)V
...
.method w(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;Ljava/util/List;IFF)V
    ...
    invoke-virtual {v0}, Landroidx/recyclerview/widget/i$h;->e()V

    invoke-virtual {p1}, Landroid/graphics/Canvas;->save()I

    move-result v12

    iget-object v3, v0, Landroidx/recyclerview/widget/i$h;->e:Landroidx/recyclerview/widget/RecyclerView$d0;

    iget v4, v0, Landroidx/recyclerview/widget/i$h;->i:F

    iget v5, v0, Landroidx/recyclerview/widget/i$h;->j:F

    iget v6, v0, Landroidx/recyclerview/widget/i$h;->f:I
    ...
    invoke-virtual/range {v0 .. v7}, Landroidx/recyclerview/widget/i$f;->u(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;FFIZ)V
...
.method x(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;Ljava/util/List;IFF)V
    ...
    invoke-virtual/range {v0 .. v7}, Landroidx/recyclerview/widget/i$f;->v(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;FFIZ)V
    ...
    iget-boolean v2, v1, Landroidx/recyclerview/widget/i$h;->l:Z

    if-eqz v2, :cond_2

    iget-boolean v1, v1, Landroidx/recyclerview/widget/i$h;->h:Z
...
.method public z(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;ILandroidx/recyclerview/widget/RecyclerView$d0;III)V
    ...
    instance-of v0, p3, Landroidx/recyclerview/widget/i$i;

    if-eqz v0, :cond_0

    check-cast p3, Landroidx/recyclerview/widget/i$i;
    ...
    invoke-interface {p3, p1, p2, p6, p7}, Landroidx/recyclerview/widget/i$i;->e(Landroid/view/View;Landroid/view/View;II)V

    return-void

    :cond_0
    invoke-virtual {p3}, Landroidx/recyclerview/widget/RecyclerView$o;->p()Z
    ...
    :cond_2
    invoke-virtual {p3}, Landroidx/recyclerview/widget/RecyclerView$o;->q()Z
    ...
    invoke-virtual {p3, p2}, Landroidx/recyclerview/widget/RecyclerView$o;->Z(Landroid/view/View;)I
    ...
    invoke-virtual {p3, p2}, Landroidx/recyclerview/widget/RecyclerView$o;->T(Landroid/view/View;)I
