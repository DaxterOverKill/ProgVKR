...
.method private A(FFFI)Lf2/g;
    .locals 1

    invoke-static {}, Lf2/k;->a()Lf2/k$b;

    move-result-object v0

    invoke-virtual {v0, p1}, Lf2/k$b;->A(F)Lf2/k$b;

    move-result-object v0

    invoke-virtual {v0, p1}, Lf2/k$b;->E(F)Lf2/k$b;

    move-result-object p1

    invoke-virtual {p1, p2}, Lf2/k$b;->s(F)Lf2/k$b;

    move-result-object p1

    invoke-virtual {p1, p2}, Lf2/k$b;->w(F)Lf2/k$b;
    ...
    invoke-static {p2, p3}, Lf2/g;->m(Landroid/content/Context;F)Lf2/g;

    move-result-object p2

    invoke-virtual {p2, p1}, Lf2/g;->setShapeAppearanceModel(Lf2/k;)V

    const/4 p1, 0x0

    invoke-virtual {p2, p1, p4, p1, p4}, Lf2/g;->Z(IIII)V
...
.method private F(Landroid/widget/AutoCompleteTextView;)V
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/d;->m:Lf2/g;
...
.method private v(Landroid/widget/AutoCompleteTextView;)V
    ...
    invoke-virtual {v1}, Lcom/google/android/material/textfield/TextInputLayout;->getBoxBackground()Lf2/g;

    move-result-object v1

    sget v2, Lo1/b;->i:I

    invoke-static {p1, v2}, Lv1/a;->c(Landroid/view/View;I)I
    ...
    invoke-direct {p0, p1, v2, v4, v1}, Lcom/google/android/material/textfield/d;->x(Landroid/widget/AutoCompleteTextView;I[[ILf2/g;)V
    ...
    invoke-direct {p0, p1, v2, v4, v1}, Lcom/google/android/material/textfield/d;->w(Landroid/widget/AutoCompleteTextView;I[[ILf2/g;)V
...
.method private w(Landroid/widget/AutoCompleteTextView;I[[ILf2/g;)V
    .locals 5
    ...
    invoke-static {p2, v0, v1}, Lv1/a;->f(IIF)I
    ...
    invoke-static {p1, p3}, Landroidx/core/view/u;->n0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p4}, Lf2/g;->C()Lf2/k;

    move-result-object v4

    invoke-direct {v0, v4}, Lf2/g;-><init>(Lf2/k;)V

    new-instance v4, Landroid/content/res/ColorStateList;

    invoke-direct {v4, p3, v2}, Landroid/content/res/ColorStateList;-><init>([[I[I)V

    invoke-virtual {v0, v4}, Lf2/g;->X(Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p1}, Landroidx/core/view/u;->G(Landroid/view/View;)I
    ...
    invoke-static {p1}, Landroidx/core/view/u;->F(Landroid/view/View;)I
    ...
    invoke-static {p1, p2}, Landroidx/core/view/u;->n0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    invoke-static {p1, p3, p4, v0, v1}, Landroidx/core/view/u;->w0(Landroid/view/View;IIII)V

    :goto_0
    return-void
.end method

.method private x(Landroid/widget/AutoCompleteTextView;I[[ILf2/g;)V
    .locals 7

    sget v0, Lo1/b;->m:I

    invoke-static {p1, v0}, Lv1/a;->c(Landroid/view/View;I)I
    ...
    invoke-static {p2, v0, v2}, Lv1/a;->f(IIF)I
    ...
    invoke-virtual {v1, v6}, Lf2/g;->X(Landroid/content/res/ColorStateList;)V

    sget-boolean v3, Lcom/google/android/material/textfield/d;->q:Z

    if-eqz v3, :cond_0

    invoke-virtual {v1, v0}, Lf2/g;->setTint(I)V
    ...
    invoke-direct {p3, v0}, Lf2/g;-><init>(Lf2/k;)V

    const/4 v0, -0x1

    invoke-virtual {p3, v0}, Lf2/g;->setTint(I)V
...
.method a()V
    ...
    invoke-direct {p0, v0, v0, v1, v2}, Lcom/google/android/material/textfield/d;->A(FFFI)Lf2/g;

    move-result-object v3

    const/4 v4, 0x0

    invoke-direct {p0, v4, v0, v1, v2}, Lcom/google/android/material/textfield/d;->A(FFFI)Lf2/g;

    move-result-object v0

    iput-object v3, p0, Lcom/google/android/material/textfield/d;->m:Lf2/g;
    ...
    invoke-static {v2, v0}, Ld/a;->d(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
