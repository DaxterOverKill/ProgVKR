...
.method protected M(Lf0/c;)V
    ...
    invoke-virtual {p1, v0}, Lf0/c;->W(Z)V
    ...
    :goto_0
    invoke-virtual {p1, v0}, Lf0/c;->Y(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v0}, Lf0/c;->t0(Ljava/lang/CharSequence;)V

    goto :goto_3

    :cond_3
    invoke-virtual {p1, v0}, Lf0/c;->c0(Ljava/lang/CharSequence;)V

    :goto_3
    return-void
.end method

.method protected N(ILf0/c;)V
    .locals 6
    ...
    :goto_0
    invoke-virtual {p2, p1}, Lf0/c;->c0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, p1}, Lf0/c;->U(Landroid/graphics/Rect;)V

    sget-object p1, Lf0/c$a;->e:Lf0/c$a;

    invoke-virtual {p2, p1}, Lf0/c;->b(Lf0/c$a;)V
    ...
    invoke-virtual {p2, p1}, Lf0/c;->d0(Z)V

    goto :goto_2

    :cond_2
    invoke-virtual {p2, v0}, Lf0/c;->c0(Ljava/lang/CharSequence;)V
