...
.field private final f:Lf2/k;


# direct methods
.method private constructor <init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILf2/k;Landroid/graphics/Rect;)V
    .locals 1
    ...
    iput-object p5, p0, Lcom/google/android/material/datepicker/b;->f:Lf2/k;
...
.method static a(Landroid/content/Context;I)Lcom/google/android/material/datepicker/b;
    ...
    invoke-static {v1, v2}, Le0/h;->a(ZLjava/lang/Object;)V

    sget-object v1, Lo1/l;->N1:[I
    ...
    invoke-static {p0, p1, v1}, Lc2/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, v1, v0}, Lf2/k;->b(Landroid/content/Context;II)Lf2/k$b;

    move-result-object p0

    invoke-virtual {p0}, Lf2/k$b;->m()Lf2/k;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/google/android/material/datepicker/b;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILf2/k;Landroid/graphics/Rect;)V
...
.method d(Landroid/widget/TextView;)V
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Lf2/k;

    invoke-virtual {v0, v2}, Lf2/g;->setShapeAppearanceModel(Lf2/k;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Lf2/k;

    invoke-virtual {v1, v2}, Lf2/g;->setShapeAppearanceModel(Lf2/k;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->c:Landroid/content/res/ColorStateList;

    invoke-virtual {v0, v2}, Lf2/g;->X(Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p1, v0}, Landroidx/core/view/u;->n0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
