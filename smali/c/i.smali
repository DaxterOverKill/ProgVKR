...
.method constructor <init>(Landroidx/appcompat/widget/Toolbar;Ljava/lang/CharSequence;Landroid/view/Window$Callback;)V
    ...
    iput-object v0, p0, Lc/i;->f:Ljava/util/ArrayList;

    new-instance v0, Lc/i$a;

    invoke-direct {v0, p0}, Lc/i$a;-><init>(Lc/i;)V

    iput-object v0, p0, Lc/i;->g:Ljava/lang/Runnable;

    new-instance v0, Lc/i$b;

    invoke-direct {v0, p0}, Lc/i$b;-><init>(Lc/i;)V

    iput-object v0, p0, Lc/i;->h:Landroidx/appcompat/widget/Toolbar$f;
    ...
    iput-object v1, p0, Lc/i;->a:Landroidx/appcompat/widget/c0;

    new-instance v1, Lc/i$e;

    invoke-direct {v1, p0, p3}, Lc/i$e;-><init>(Lc/i;Landroid/view/Window$Callback;)V

    iput-object v1, p0, Lc/i;->c:Landroid/view/Window$Callback;

    iget-object p3, p0, Lc/i;->a:Landroidx/appcompat/widget/c0;
    ...
    iget-object p1, p0, Lc/i;->a:Landroidx/appcompat/widget/c0;
...
.method private x()Landroid/view/Menu;
    ...
    iget-boolean v0, p0, Lc/i;->d:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Lc/i;->a:Landroidx/appcompat/widget/c0;

    new-instance v1, Lc/i$c;

    invoke-direct {v1, p0}, Lc/i$c;-><init>(Lc/i;)V

    new-instance v2, Lc/i$d;

    invoke-direct {v2, p0}, Lc/i$d;-><init>(Lc/i;)V

    invoke-interface {v0, v1, v2}, Landroidx/appcompat/widget/c0;->i(Landroidx/appcompat/view/menu/j$a;Landroidx/appcompat/view/menu/e$a;)V
...
.method public A(II)V
    ...
    iget-object v1, p0, Lc/i;->a:Landroidx/appcompat/widget/c0;
...
.method public i(Z)V
    ...
    :cond_0
    iput-boolean p1, p0, Lc/i;->e:Z

    iget-object v0, p0, Lc/i;->f:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Lc/i;->f:Ljava/util/ArrayList;
...
.method public l()Z
    ...
    iget-object v1, p0, Lc/i;->g:Ljava/lang/Runnable;
    ...
    invoke-static {v0, v1}, Landroidx/core/view/u;->c0(Landroid/view/View;Ljava/lang/Runnable;)V
...
.method public m(Landroid/content/res/Configuration;)V
    ...
    invoke-super {p0, p1}, Lc/a;->m(Landroid/content/res/Configuration;)V
...
.method public o(ILandroid/view/KeyEvent;)Z
    ...
    invoke-direct {p0}, Lc/i;->x()Landroid/view/Menu;
...
.method public s(Z)V
    ...
    :goto_0
    invoke-virtual {p0, p1, v0}, Lc/i;->A(II)V
...
.method public y()Landroid/view/Window$Callback;
    ...
    iget-object v0, p0, Lc/i;->c:Landroid/view/Window$Callback;
...
.method z()V
    ...
    iget-object v3, p0, Lc/i;->c:Landroid/view/Window$Callback;
