...
# direct methods
.method constructor <init>(Lu/h$d;)V
    .locals 11
    ...
    iput-object v0, p0, Lu/i;->e:Ljava/util/List;

    new-instance v0, Landroid/os/Bundle;

    invoke-direct {v0}, Landroid/os/Bundle;-><init>()V

    iput-object v0, p0, Lu/i;->f:Landroid/os/Bundle;

    iput-object p1, p0, Lu/i;->b:Lu/h$d;
    ...
    iget-object v3, p1, Lu/h$d;->a:Landroid/content/Context;

    if-lt v0, v1, :cond_0

    iget-object v4, p1, Lu/h$d;->I:Ljava/lang/String;
    ...
    :goto_0
    iput-object v2, p0, Lu/i;->a:Landroid/app/Notification$Builder;

    iget-object v2, p1, Lu/h$d;->P:Landroid/app/Notification;

    iget-object v3, p0, Lu/i;->a:Landroid/app/Notification$Builder;
    ...
    iget-object v5, p1, Lu/h$d;->h:Landroid/widget/RemoteViews;
    ...
    iget-object v4, p1, Lu/h$d;->d:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentTitle(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Lu/h$d;->e:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentText(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Lu/h$d;->j:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentInfo(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Lu/h$d;->f:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Lu/h$d;->g:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Lu/h$d;->i:Landroid/graphics/Bitmap;
    ...
    iget v4, p1, Lu/h$d;->k:I

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setNumber(I)Landroid/app/Notification$Builder;

    move-result-object v3

    iget v4, p1, Lu/h$d;->r:I

    iget v9, p1, Lu/h$d;->s:I

    iget-boolean v10, p1, Lu/h$d;->t:Z
    ...
    iget-object v4, p0, Lu/i;->a:Landroid/app/Notification$Builder;
    ...
    iget-object v0, p0, Lu/i;->a:Landroid/app/Notification$Builder;

    iget-object v8, p1, Lu/h$d;->p:Ljava/lang/CharSequence;
    ...
    check-cast v8, Lu/h$a;

    invoke-direct {p0, v8}, Lu/i;->b(Lu/h$a;)V

    goto :goto_5

    :cond_6
    iget-object v0, p1, Lu/h$d;->B:Landroid/os/Bundle;

    if-eqz v0, :cond_7

    iget-object v8, p0, Lu/i;->f:Landroid/os/Bundle;
    ...
    iget-boolean v0, p1, Lu/h$d;->x:Z

    if-eqz v0, :cond_8

    iget-object v0, p0, Lu/i;->f:Landroid/os/Bundle;
    ...
    :cond_8
    iget-object v0, p1, Lu/h$d;->u:Ljava/lang/String;
    ...
    :cond_a
    iget-object v0, p1, Lu/h$d;->w:Ljava/lang/String;
    ...
    :cond_b
    iget-object v0, p1, Lu/h$d;->F:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lu/i;->c:Landroid/widget/RemoteViews;

    iget-object v0, p1, Lu/h$d;->G:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lu/i;->d:Landroid/widget/RemoteViews;
    ...
    iget-object v8, p0, Lu/i;->a:Landroid/app/Notification$Builder;

    iget-boolean v9, p1, Lu/h$d;->m:Z

    invoke-virtual {v8, v9}, Landroid/app/Notification$Builder;->setShowWhen(Z)Landroid/app/Notification$Builder;

    if-ge v0, v3, :cond_d

    iget-object v8, p1, Lu/h$d;->R:Ljava/util/ArrayList;
    ...
    iget-object v9, p1, Lu/h$d;->R:Ljava/util/ArrayList;
    ...
    iget-object v0, p1, Lu/h$d;->R:Ljava/util/ArrayList;
    ...
    :cond_f
    iget-object v0, p1, Lu/h$d;->H:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lu/i;->h:Landroid/widget/RemoteViews;

    iget-object v0, p1, Lu/h$d;->c:Ljava/util/ArrayList;
    ...
    invoke-virtual {p1}, Lu/h$d;->c()Landroid/os/Bundle;
    ...
    :goto_8
    iget-object v9, p1, Lu/h$d;->c:Ljava/util/ArrayList;
    ...
    iget-object v10, p1, Lu/h$d;->c:Ljava/util/ArrayList;

    invoke-virtual {v10, v8}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v10

    check-cast v10, Lu/h$a;

    invoke-static {v10}, Lu/j;->b(Lu/h$a;)Landroid/os/Bundle;
    ...
    iget-object v4, p0, Lu/i;->f:Landroid/os/Bundle;
    ...
    iget-object v4, p1, Lu/h$d;->B:Landroid/os/Bundle;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setExtras(Landroid/os/Bundle;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Lu/h$d;->q:[Ljava/lang/CharSequence;
    ...
    iget-object v3, p1, Lu/h$d;->F:Landroid/widget/RemoteViews;
    ...
    :cond_13
    iget-object v3, p1, Lu/h$d;->G:Landroid/widget/RemoteViews;
    ...
    :cond_14
    iget-object v3, p1, Lu/h$d;->H:Landroid/widget/RemoteViews;
    ...
    iget-object v7, p1, Lu/h$d;->O:Lu/h$c;

    invoke-static {v7}, Lu/h$c;->a(Lu/h$c;)Landroid/app/Notification$BubbleMetadata;
    ...
    :cond_18
    iget-boolean p1, p1, Lu/h$d;->Q:Z

    if-eqz p1, :cond_1b

    iget-object p1, p0, Lu/i;->b:Lu/h$d;

    iget-boolean p1, p1, Lu/h$d;->v:Z
    ...
    :goto_9
    iget-object p1, p0, Lu/i;->a:Landroid/app/Notification$Builder;
    ...
    iget-object v2, p0, Lu/i;->a:Landroid/app/Notification$Builder;
    ...
    iget-object p1, p1, Lu/h$d;->u:Ljava/lang/String;
...
.method private b(Lu/h$a;)V
    ...
    invoke-virtual {p1}, Lu/h$a;->e()Landroidx/core/graphics/drawable/IconCompat;
    ...
    :goto_0
    invoke-virtual {p1}, Lu/h$a;->i()Ljava/lang/CharSequence;

    move-result-object v2

    invoke-virtual {p1}, Lu/h$a;->a()Landroid/app/PendingIntent;
    ...
    :goto_2
    invoke-virtual {p1}, Lu/h$a;->f()[Lu/l;
    ...
    invoke-static {v1}, Lu/l;->b([Lu/l;)[Landroid/app/RemoteInput;
    ...
    :cond_3
    invoke-virtual {p1}, Lu/h$a;->d()Landroid/os/Bundle;
    ...
    iget-object v0, p0, Lu/i;->e:Ljava/util/List;

    iget-object v1, p0, Lu/i;->a:Landroid/app/Notification$Builder;

    invoke-static {v1, p1}, Lu/j;->f(Landroid/app/Notification$Builder;Lu/h$a;)Landroid/os/Bundle;
...
.method public c()Landroid/app/Notification;
    ...
    iget-object v0, p0, Lu/i;->b:Lu/h$d;

    iget-object v0, v0, Lu/h$d;->o:Lu/h$e;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0}, Lu/h$e;->b(Lu/g;)V

    :cond_0
    if-eqz v0, :cond_1

    invoke-virtual {v0, p0}, Lu/h$e;->d(Lu/g;)Landroid/widget/RemoteViews;
    ...
    :goto_0
    invoke-virtual {p0}, Lu/i;->d()Landroid/app/Notification;
    ...
    :cond_2
    iget-object v1, p0, Lu/i;->b:Lu/h$d;

    iget-object v1, v1, Lu/h$d;->F:Landroid/widget/RemoteViews;
    ...
    invoke-virtual {v0, p0}, Lu/h$e;->c(Lu/g;)Landroid/widget/RemoteViews;
    ...
    iget-object v4, p0, Lu/i;->b:Lu/h$d;

    iget-object v4, v4, Lu/h$d;->o:Lu/h$e;

    invoke-virtual {v4, p0}, Lu/h$e;->e(Lu/g;)Landroid/widget/RemoteViews;
    ...
    invoke-static {v2}, Lu/h;->a(Landroid/app/Notification;)Landroid/os/Bundle;

    move-result-object v1

    if-eqz v1, :cond_6

    invoke-virtual {v0, v1}, Lu/h$e;->a(Landroid/os/Bundle;)V
...
.method protected d()Landroid/app/Notification;
    ...
    invoke-direct {p0, v0}, Lu/i;->e(Landroid/app/Notification;)V
    ...
    iget-object v1, p0, Lu/i;->f:Landroid/os/Bundle;
    ...
    iget-object v1, p0, Lu/i;->c:Landroid/widget/RemoteViews;
    ...
    :cond_4
    iget-object v1, p0, Lu/i;->d:Landroid/widget/RemoteViews;
    ...
    :cond_5
    iget-object v1, p0, Lu/i;->h:Landroid/widget/RemoteViews;
    ...
    invoke-static {v0}, Lu/j;->a(Ljava/util/List;)Landroid/util/SparseArray;
    ...
    invoke-static {v0}, Lu/h;->a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    iget-object v1, p0, Lu/i;->e:Ljava/util/List;

    invoke-static {v1}, Lu/j;->a(Ljava/util/List;)Landroid/util/SparseArray;
